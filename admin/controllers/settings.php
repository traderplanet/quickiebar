...
class qb_settings
{
    ...
    {
        update_option(true, 'qb_subscribed');
    ...
    {
        update_option('qb_visibility_authenticated_only', $settings['visibility_authenticated_only']);
    ...
    function enqueue_scripts_for_view()
    {
        ...
        wp_localize_script('qb-settings', 'qb_settings', array(
            ...
            'visibility_authenticated_only' => get_option('qb_visibility_authenticated_only'),
