jQuery(document).ready(function($){
	...
	function ViewModel() {
		...
		self.DEFAULT_BAR_OPTIONS = {
			...
			visibility_authenticated_only: 'onhover'
		}
		...
		self.barOptions = {
			...
			visibility_authenticated_only: ko.observable(self.DEFAULT_BAR_OPTIONS.visibility_authenticated_only)
		}
		...
		self.mapBarPropertiesToBarOptions = function(bar){
			...
			self.barOptions.visibility_authenticated_only(bar.visibility_authenticated_only);
