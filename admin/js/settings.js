jQuery(document).ready(function($){
	...
	function ViewModel() {
		...
		self.settings.cacheCurrentSettings = function(){
			...
			self.settings.cache.showtologoned(self.settings.showtologoned());
		...
		self.settings.dirty = ko.computed(function(){
			...
			if(self.settings.attribution() != self.settings.cache.attribution() ||
				...
				self.settings.showtologoned() != self.settings.cache.showtologoned() ||
			...
			$.ajax({
				...
				data: {
					...
					settings: {
						...
						showtologoned: self.settings.showtologoned(),
		...
		self.syncData = function(){
			...
			self.settings.showtologoned(qb_settings.showtologoned);
